...
class RankingBuffer(object):
    ...
    def insert(self, obs, acs, ret, cur_tmp, total_tmp, cur_w1, cur_w2):
        if ret>0:
            cur_w1 = self.w1*(total_tmp-cur_tmp)/total_tmp
            cur_w2 = self.w2*(total_tmp-cur_tmp)/total_tmp
