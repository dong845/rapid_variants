...
def argparser():
    ...
    parser.add_argument('--choice_type', help='Choice of sampling', type=str, default="original")  # possible choices: original, softmax, epsilon-greedy
    return parser

def main():
    parser = argparser()
    args = parser.parse_args()
    dir_name = args.env+"_"+args.choice_type
    logger.configure(dir=dir_name)
    train(args)
